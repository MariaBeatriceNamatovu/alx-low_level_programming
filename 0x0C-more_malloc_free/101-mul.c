...
char get_prod(char *prod, char *mult, int digit, int zeroes);
void add_nums(char *final_prod, char *next_prod, int next_len);

/**
 * find_len - finds the legnth of string
...
int find_len(char *str)
{
 ...
 /**
  * create_xarray - creates array o. chars & init. it w. char x. as term. null.
  * @size: the size of array to be initialized
  *
  * Description: if there is insufficient space, fn exists in status of 98
  *
...
/**
 * iterate_zeroes - iterates thru string of no.s hvin' leading zeroes
 * @str: the string of numbers to be iterated
 *
 * Return: A pointer to next non-zero element
 */
 ...
 *
 * Description: if multiple hs a non-digit, fn. exits with status value of 98
 *
 * Return: ..
 */
 ...
 *
 * Description: if no. ofargs is wrong /no. has non-digits fn exits w. status98
 *
 * Return: Always 0
 */
